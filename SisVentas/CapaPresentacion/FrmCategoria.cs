...
namespace CapaPresentacion
{
    ...
    {
        //Controla si se esta ingresando o editando un nuevo registro
        ...
        //validando cajas de tesxto vacios
        private void Habilitar(bool valor)
        {
            //solo lectura va ser false
        ...
        private void Botones()
        {
            ...
            {
                this.Habilitar(true);//habilita caja de textos
            ...
            {
                this.Habilitar(false);//habilita caja de textos
